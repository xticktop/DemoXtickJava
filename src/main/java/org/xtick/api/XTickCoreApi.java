...
public class XTickCoreApi {
     ...
     */
    public String getDayUpdate(String dataType, String symbol, String tradeDate, String token, MethodType method) throws IOException {
        String url = XTickConst.serverUrl + "/doc/core/dayupdate";
